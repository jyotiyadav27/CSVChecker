  ...
  <div class="container py-md-5">
      <div class="row align-items-center">
        <div class="col-lg-7 py-3 py-md-5">
          <h1 class="display-3">CSV Checker</h1>
          <p class="lead text-muted"> Bulk Upload to DRDO's Digital library</p>
        </div>
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <button type="submit" class="py-3 mt-4 btn btn-lg btn-success btn-block">Sign up for Bulk Uploading</button>
          </form>
        </div>
      </div>
    </div>
